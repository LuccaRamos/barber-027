...
export default function Home() {
  return (
    <main className="flex max-h-screen min-h-[calc(100vh-32px)] flex-col items-center justify-between rounded-xl p-3 bg-[url('/bg.jpg')] bg-cover shadow-lg">
      ...
      {/* CORPO */}
      <div className='container w-full flex justify-around items-center'>
        <div className='flex justify-normal flex-col w-2/4'>
          <h1 className='text-white text-5xl font-bold'>Venha conhecer a melhor barbearia do <span className='text-[#0097e2]'>Espírito</span> <span className='text-[#f09cbf]'>Santo!</span></h1>
          <p className='text-white mt-10'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
      ...
      {/* FOOTER */}
      <div className='container flex w-full mt-5 mb-3 flex-row justify-center items-center'>
